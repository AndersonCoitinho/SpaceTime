...
export default function Home() {
  return (
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex flex-col items-start justify-between overflow-hidden bg-[url(../assets/bg-stars.svg)] bg-cover px-28 pt-16">
        {/* Blur */}
        ...
        <div className="space-y-5">
          ...
          <div className="max-w-[420px] space-y-1">
            ...
            <p>
              Colecione momento marcantes da sua jornada e compartilhe (se
              quiser) com o mundo!
            </p>
          </div>
          <a
